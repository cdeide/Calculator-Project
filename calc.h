 ...
 */
  ...
  /*
  pre: instance of Calc exists. Two characters are passed to be evaluated based on given operator.
  post: returns an integer value of the result of the equation.
 */
  int Comp(char ch1, char ch2, char oper);
